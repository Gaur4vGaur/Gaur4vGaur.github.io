...
math: true
image:
  path: /assets/blog_assets/img/cloudnative/2026-03-16-monitoring-cloud-native-services-part2/coverImage.png
  width: 800
  height: 500
---
...
![Error Rate](/assets/blog_assets/img/cloudnative/2026-03-16-monitoring-cloud-native-services-part2/errorRate.png){: w="700" h="400" }*Infer Error Rate*
...
`hikaricp_connections_active`<br>
`hikaricp_connections_idle`<br>
`hikaricp_connections_pending`

The critical one is:<br>
`hikaricp_connections_pending`

If pending connections increase steadily, saturation is approaching and action is needed.

### Kubernetes saturation signals
Container platforms introduce new saturation points. An important metric to monitor is: <br>
...
**Are we failing… or is the dependency failing?**<br>
